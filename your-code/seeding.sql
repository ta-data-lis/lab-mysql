...
INSERT INTO lab_mysql.customers(customer_id, name, phone_number, address, city, country, zip_code)
Values(10001, 'Pablo Picasso', '+34 636 17 63 82', 'Paseo de la Chopera 14', 'Madrid', 'Spain', 28045);

INSERT INTO lab_mysql.customers(customer_id, name, phone_number, address, city, country, zip_code)
Values (20001, 'Abraham Lincoln', '+1 305 907 7086', '120 SW 8th St', 'Miami', 'United States', 33130);
