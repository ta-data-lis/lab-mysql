...
CREATE TABLE cars (car_id INT, primary key(car_id), invoice_id INT, car_model VARCHAR(20) , car_color VARCHAR(20), car_year INT(4), car_vim VARCHAR(20) UNIQUE);
...
CREATE TABLE invoices (invoice_id INT, primary key(invoice_id), invoice_date date, car_id INT references cars.car_id ,cust_id INT, staff_id INT,
